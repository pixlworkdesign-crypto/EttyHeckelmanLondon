...
export function ProductDetail({ product }: { product: Product }) {
  ...
  return (
    <div className="grid lg:grid-cols-[minmax(0,560px)_1fr] gap-10 lg:gap-16 items-start">
      {/* Gallery */}
      <div className="flex flex-col-reverse md:flex-row gap-4 w-full max-w-[560px] mx-auto lg:mx-0">
        {images.length > 1 && (
